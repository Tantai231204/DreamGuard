      ...
      <div className="flex items-center gap-6">
        <div className="relative flex-1 max-w-2xl">
          ...
          <Input
            ...
            className="pl-14 pr-12 h-12 rounded-xl border-2 border-gray-200 bg-white shadow-sm hover:border-gray-300 focus:border-[var(--color-primary)] focus:ring-4 focus:ring-[var(--color-primary)]/10 transition-all text-base font-medium"
          />
          {value && (
            <Button
              variant="ghost"
