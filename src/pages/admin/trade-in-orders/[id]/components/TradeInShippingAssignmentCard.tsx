...
export function TradeInShippingAssignmentCard({
  tradeInOrderId,
  onOpenAssign,
  canAssign,
  delay = 0,
  ...
  const activeTask = sortedTasks.find((task) => task.status !== "Reassigned");
        ...
        {currentStaff ? (
          <div className="space-y-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-2 inline-flex items-center gap-1.5 rounded-md border border-blue-100 bg-blue-50/60 px-2 py-1">
                  ...
                  <span className="text-[10px] font-bold text-blue-700 uppercase tracking-wide">
                    Appointment: {appointmentTime ? formatDateTime(appointmentTime) : "Not Scheduled"}
                  </span>
                </div>
              </div>
            </div>
            ...
            {activeTask?.staffNote && (() => {
              const parts = activeTask.staffNote.split(MANAGER_NOTE_SPLITTER);
