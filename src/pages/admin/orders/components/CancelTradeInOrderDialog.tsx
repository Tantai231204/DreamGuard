...
export function CancelTradeInOrderDialog({
  ...
  const handleConfirm = () => {
    if (!reason) {
      setError('Please select a reason for administrative cancellation.');
      return;
    }
    setError('');
          ...
          <div className="relative z-10 flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                <span className="px-2 py-0.5 rounded-md bg-rose-100 text-rose-600 text-[9px] font-black uppercase tracking-widest">Administrative Override</span>
        ...
        <div className="p-8 space-y-7 bg-white">
          ...
          <div className="flex items-start gap-4 p-5 bg-amber-50/60 border border-amber-100/50 rounded-[22px] relative group overflow-hidden">
             ...
             <p className="text-[12.5px] text-amber-900/80 leading-relaxed font-semibold">
               This action will <span className="font-black text-amber-600 underline underline-offset-4">cancel the trade-in</span>, trigger a refund if applicable, and restore inventory.
             </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <SelectContent className="rounded-2xl border-slate-100 shadow-3xl p-1.5 overflow-hidden">
                  ...
                  <SelectItem value="Product Inspection Failed" className="rounded-xl py-3 cursor-pointer">Product Inspection Failed</SelectItem>
                  <SelectItem value="Price Disagreement" className="rounded-xl py-3 cursor-pointer">Price Disagreement</SelectItem>
                  <SelectItem value="Fraud Suspicion" className="rounded-xl py-3 cursor-pointer">Fraud Suspicion</SelectItem>
                  <SelectItem value="Incomplete Documentation" className="rounded-xl py-3 cursor-pointer">Incomplete Documentation</SelectItem>
                  <SelectItem value="Other (Administrative)" className="rounded-xl py-3 cursor-pointer">Other (Administrative)</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="space-y-3">
              ...
              <textarea
                rows={3}
                placeholder="Briefly state the reason for administrative termination..."
