        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 bg-slate-50/80 shrink-0">
                <div className="flex items-center gap-2">
                    ...
                    {items.length > 0 && (
                        <Badge variant="secondary" className="h-5 text-[10px] font-bold px-1.5 bg-primary-100 text-primary-700 border-0">
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            'bg-primary-600 text-white hover:bg-primary-700 transition-all shadow-sm',
                ...
                {items.length === 0 ? (
                    <button
                        ...
                        className={cn(
                            ...
                            'hover:border-primary-500/40 hover:bg-primary-50/30 transition-all cursor-pointer',
                            'disabled:cursor-not-allowed disabled:opacity-50',
                        )}
                    >
                        <div className="h-14 w-14 rounded-2xl bg-primary-100 flex items-center justify-center mb-3">
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 px-3 pt-2.5 pb-2">
                                    ...
                                    <div className={cn(
                                        ...
                                        hasVariant ? 'bg-primary-100 text-primary-700' : 'bg-orange-100 text-orange-600',
                                    )}>
                                        {index + 1}
                                    </div>
                                    ...
                                    {!hasVariant ? (
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex items-center gap-0.5">
                                                <button type="button"
                                                    className="h-6 w-6 rounded-md flex items-center justify-center hover:bg-primary-50 hover:text-primary-700 text-slate-400 transition-all disabled:opacity-30"
                                                ...
                                                <input
                                                    ...
                                                    disabled={disabled}
                                                    className="h-6 w-9 text-center text-xs font-bold rounded-md border border-slate-200 bg-slate-50 outline-none focus:border-primary-500 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                                />
                                                <button type="button"
                                                    className="h-6 w-6 rounded-md flex items-center justify-center hover:bg-primary-50 hover:text-primary-700 text-slate-400 transition-all disabled:opacity-30"
                                                    onClick={() => handleQty(item.id, item.quantity + 1)}
