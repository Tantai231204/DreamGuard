...
export const serviceItems: ServiceItemOption[] = [
  // Deep clean
  { id: "dc-1", name: "King-size mattress (1.8m)", unitPrice: 45, serviceType: "deep_clean" },
  { id: "dc-2", name: "Queen-size mattress (1.6m)", unitPrice: 40, serviceType: "deep_clean" },
  { id: "dc-3", name: "Single mattress (1.2m)", unitPrice: 30, serviceType: "deep_clean" },
  { id: "dc-4", name: "Fabric sofa", unitPrice: 35, serviceType: "deep_clean" },
  // Basic clean
  { id: "bc-1", name: "Full bedding set (double)", unitPrice: 25, serviceType: "basic_clean" },
  { id: "bc-2", name: "Full bedding set (single)", unitPrice: 18, serviceType: "basic_clean" },
  { id: "bc-3", name: "Blanket", unitPrice: 10, serviceType: "basic_clean" },
  { id: "bc-4", name: "Pillow (each)", unitPrice: 5, serviceType: "basic_clean" },
  // Mattress clean
  { id: "mc-1", name: "Double mattress (1.8m)", unitPrice: 35, serviceType: "mattress_clean" },
  { id: "mc-2", name: "Single mattress (1.2m)", unitPrice: 25, serviceType: "mattress_clean" },
  { id: "mc-3", name: "Baby crib mattress", unitPrice: 18, serviceType: "mattress_clean" },
  { id: "mc-4", name: "Bed sheet", unitPrice: 8, serviceType: "mattress_clean" },
  // Stroller clean
  { id: "sc-1", name: "Single stroller", unitPrice: 28, serviceType: "stroller_clean" },
  { id: "sc-2", name: "Double stroller", unitPrice: 38, serviceType: "stroller_clean" },
  { id: "sc-3", name: "Portable bassinet", unitPrice: 20, serviceType: "stroller_clean" },
  // Car seat clean
  { id: "cs-1", name: "Infant car seat (Group 0+)", unitPrice: 20, serviceType: "carseat_clean" },
  { id: "cs-2", name: "Toddler car seat (Group 1-2)", unitPrice: 25, serviceType: "carseat_clean" },
  { id: "cs-3", name: "Booster seat", unitPrice: 15, serviceType: "carseat_clean" },
  // Toy sanitize
  { id: "ts-1", name: "Plastic toy set (10 items)", unitPrice: 15, serviceType: "toy_sanitize" },
  { id: "ts-2", name: "Large stuffed animal (>30cm)", unitPrice: 10, serviceType: "toy_sanitize" },
  { id: "ts-3", name: "Small stuffed animal (<30cm)", unitPrice: 7, serviceType: "toy_sanitize" },
  { id: "ts-4", name: "Wooden toy set", unitPrice: 12, serviceType: "toy_sanitize" },
];
