    ...
    <div className="flex flex-col h-full bg-white rounded-[2.5rem] border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.04)] overflow-hidden">
          ...
          {TABS.map((tab) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "w-full group flex items-center gap-4 rounded-2xl px-5 py-3.5 transition-all duration-300 relative overflow-hidden",
                  !isActive && "hover:bg-slate-50 text-slate-500 hover:text-slate-900"
                )}
              >
                {/* Liquid Sliding Active Indicator */}
                {isActive && (
                  <motion.div
                    layoutId="active-pill"
                    className="absolute inset-0 bg-primary z-0 shadow-[0_8px_20px_-6px_rgba(73,136,196,0.4)]"
                ...
                <div className={cn(
                  "w-10 h-10 rounded-[0.85rem] flex items-center justify-center transition-all duration-300 relative z-20",
                  isActive
                ...
                <span className={cn(
                  "flex-1 text-left text-[14px] font-bold tracking-tight relative z-20",
                  isActive ? "text-white" : "text-slate-600 font-medium"
                )}>
                  {tab.label}
                </span>
                ...
                {tab.badge && (
                  <span className={cn(
                    "min-w-[20px] h-5 flex items-center justify-center text-[9px] font-black px-1.5 rounded-lg transition-transform duration-300 group-hover:scale-110 relative z-20",
      ...
      <div className="mt-auto p-6 shrink-0 space-y-4">
        <div className="relative group bg-slate-900 rounded-[2.5rem] p-6 text-white shadow-2xl overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-primary/20 rounded-full -mr-16 -mt-16 blur-2xl group-hover:bg-primary/30 transition-all duration-700" />
          <div className="relative z-10 flex flex-col gap-4">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-primary flex items-center justify-center shadow-xl shadow-primary/20 group-hover:rotate-12 transition-transform duration-500">
            ...
            <Button
              className="relative w-full h-12 rounded-xl bg-white text-slate-900 text-[10px] font-black tracking-[0.2em] shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-500 active:scale-[0.98] group/btn overflow-hidden border-none"
            >
              {/* Organic Curved Wave Filling Effect */}
              <div className="absolute -bottom-[160%] left-[-50%] w-[200%] h-[300%] bg-primary rounded-[38%] group-hover/btn:-bottom-[40%] transition-all duration-[1200ms] ease-[cubic-bezier(0.19,1,0.22,1)] animate-[spin_10s_linear_infinite] z-0" />
              <div className="absolute -bottom-[165%] left-[-40%] w-[200%] h-[300%] bg-primary/25 rounded-[35%] group-hover/btn:-bottom-[35%] transition-all duration-[1500ms] ease-[cubic-bezier(0.19,1,0.22,1)] animate-[spin_8s_linear_infinite] z-0" />
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-white border border-slate-100 flex items-center justify-center group-hover:bg-rose-100/50 group-hover:border-transparent transition-colors shadow-sm">
