...
const TABS: Tab[] = [
  ...
  },
  {
    id: "babies",
    label: "Baby Profiles",
    icon: <Baby className="h-[18px] w-[18px]" strokeWidth={2} />,
    badge: 2,
  },
  {
    id: "orders",
  ...
  },
  {
    id: "resell",
    label: "Resell Items",
    icon: <RefreshCw className="h-[18px] w-[18px]" strokeWidth={2} />,
  },
  {
    id: "wishlist",
    label: "Wishlist",
        ...
        <CardContent className="p-5 -mt-8">
          ...
          <div className="mt-5 rounded-xl bg-gradient-to-r from-[#e6f7fb] to-[#bde8f5] p-4 border border-[#94d9ef]/50">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-[#3a73a8] font-medium">
                  Accumulated Points
                </p>
              ...
              {TABS.map((tab) => {
                ...
                return (
                  <li key={tab.id}>
                    ...
                    >
                      <span
                        className={`${isActive ? "text-white" : "text-gray-400 group-hover:text-[#4988c4]"} transition-colors`}
                      >
                        {tab.icon}
                      </span>
