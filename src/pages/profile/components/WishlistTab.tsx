        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                    {data?.totalCount || 0} favorite products in the list
                </p>
            </div>
                        ...
                        <Card key={item.id} className="group overflow-hidden hover:shadow-lg transition-all">
                            ...
                            <div className="relative aspect-square bg-gray-100">
                                ...
                                <button
                                    ...
                                    className="absolute top-3 right-3 p-2 rounded-full bg-white text-red-500"
                                >
                ...
                <Card>
                    <CardContent className="py-16 text-center">
                        ...
                        <p className="text-sm text-gray-500">
                            Add products to your favorite list to see them here
                        </p>
                    </CardContent>
                </Card>
