...
export default function WarrantyPolicyPage() {
  ...
  useEffect(() => {
    setItems([
      ...
      { label: "Warranty Policy", active: true },
    ]);
  ...
  return (
    <div className="bg-white text-[#4988c4]-900">
      <section className="relative overflow-hidden border-b border-[#4988c4]/30 bg-[radial-gradient(circle_at_top_left,_rgba(73,136,196,0.2),_transparent_40%),linear-gradient(135deg,_#4988c4_0%,_#ffffff_52%,_rgba(73,136,196,0.12)_100%)]">
        {" "}
      ...
      <section className="container mx-auto max-w-7xl px-6 py-14 lg:px-8">
        ...
        >
          ...
          <div className="flex mt-8 grid gap-4 md:grid-cols-2">
