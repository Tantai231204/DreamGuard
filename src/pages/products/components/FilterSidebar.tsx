                        ...
                        <div className="flex items-center justify-between gap-3">
                            <div className="flex-1 flex flex-col gap-1">
                                ...
                                <div className="bg-slate-50 rounded-xl px-4 py-2 border border-slate-100 flex items-baseline gap-1">
                                    <span className="text-[14px] font-black text-slate-700 tabular-nums">{priceRange[0]}.000</span>
                            ...
                            <div className="flex-1 flex flex-col gap-1">
                                ...
                                <div className="bg-slate-50 rounded-xl px-4 py-2 border border-slate-100 flex items-baseline gap-1">
                                    <span className="text-[14px] font-black text-slate-700 tabular-nums">{priceRange[1]}.000</span>
                                    <span className="text-[10px] text-slate-300 font-bold">VNĐ</span>
                                </div>
                            </div>
                        </div>
