    ...
    return payload
        ...
        .map((item) => {
            ...
            return {
                ...
                productVariantImageUrl: typeof item.productVariantImageUrl === 'string' ? item.productVariantImageUrl : undefined,
                image: (typeof item.image === 'string' ? item.image : (typeof item.imageUrl === 'string' ? item.imageUrl : undefined)),
